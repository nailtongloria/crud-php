...
include_once 'C:/wamp64/www/cursophp.com/28-crud/includes/message.php';
?>
		...
		<table class="striped">
			...
			<tbody>
				...
				<tr>
					...
					<td><a href="#modal <?php echo $dados['id']; ?>" class="btn-floating red modal-trigger"><i class="material-icons">delete
					</a></td>
